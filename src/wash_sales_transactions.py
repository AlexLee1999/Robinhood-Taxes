class Wash_Sales_Transactions:
    def __init__(self, name, original_name, acquired_date, sold_date, proceeds, cost, gain_type, quantity, gain):
        self._name = name
    ...
    def to_csv(self):
        return f"{self._name},{self._original_name},{self._acquired_date},{self._sold_date},{self._proceeds:.2f},{self._cost:.2f},{self._gain_type},{self._quantity:.2f}\n"